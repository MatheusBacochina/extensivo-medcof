...
const extensivo2024rcirurgia = {
  ["extensivo-2024-r-cirurgia"]: {
    name: "Extensivo 2024 - R+ Cirurgia - Grupo MedCof",
    ...
    cards: [
      {
        ...
        url: "https://vendas.grupomedcof.com.br/pay/2024-extensivo-r-cirurgia-blacknovember",
        steps: [
          <p
            key={1}
      ...
      },
      {
        ...
        url: "https://vendas.grupomedcof.com.br/pay/2024-extensivo-r-cirurgia-elite-blacknovember",
        steps: [
          <p
            key={1}
            className="text-white flex items-center gap-2 text-left mt-4 font-normal grow-0 text-sm font-sora"
      ...
      },
      {
        ...
        url: "https://vendas.grupomedcof.com.br/pay/2024-extensivo-r-cirurgia-premium-blacknovember",
        steps: [
          <p
            key={1}
            className="text-white flex items-center gap-2 text-left mt-4 font-normal grow-0 text-sm font-sora"
...
export default extensivo2024rcirurgia;
