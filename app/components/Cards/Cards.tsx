...
const Cards = ({ elements }: any) => {
  return (
    <div id="price" className="background-cards relative flex gap-2 items-center flex-wrap-reverse py-10 justify-center px-6">
      {elements.map(({title, order, steps, price, avista, de}:{de: string, title: string, order: string, steps: any, price: string, avista: string}, index1: number) => {
