    ...
    cards: [
      {
        ...
        url: "https://vendas.grupomedcof.com.br/pay/extensivo-r-cirurgia",
        steps: [
          <p
            key={1}
      ...
      },
      {
        ...
        url: "https://vendas.grupomedcof.com.br/pay/extensivo-r-cirurgia-elite",
        steps: [
          <p
            key={1}
            className="text-white flex items-center gap-2 text-left mt-4 font-normal grow-0 text-sm font-sora"
      ...
      },
      {
        ...
        url: "https://vendas.grupomedcof.com.br/pay/extensivo-cirurgia-elite-premium",
        steps: [
          <p
            key={1}
            className="text-white flex items-center gap-2 text-left mt-4 font-normal grow-0 text-sm font-sora"
