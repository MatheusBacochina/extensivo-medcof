...
const cards = {
  center: ({steps, order}: {steps :[string], order: string}) => {
    return (
      <div className={`basis-[350px] ${order} grow-0 px-6 py-10 flex flex-col items-center ${order === 'centerCard' ? 'max-[1129px]:order-1 max-[770px]:order-4' : ''}`}>
